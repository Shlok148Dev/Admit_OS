// Run with: docker run --rm -i --network=admitos_default grafana/k6 run - < infra/loadtests/soak_test.js
...
export const options = {
  stages: [
    { duration: '10s', target: 15 }, // Warm-up to 15 users
    { duration: '100s', target: 15 }, // Hold sustained load

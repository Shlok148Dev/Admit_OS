...
from services.career.db import Base, get_db
...
test_engine = create_engine(
    "sqlite:///./test_career.db", connect_args={"check_same_thread": False}
)
...
def test_compare_branches_endpoint(mock_get_sess):
    ...
    mock_session.run.side_effect = [mock_res_cs, [], [], [], mock_res_ec, [], [], []]

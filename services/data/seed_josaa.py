...
REAL_CUTOFFS_BASE: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "ranks": {
            ...
            2023: (426, 612),
            2024: (432, 622),
        },  # source: josaa.nic.in/2024/round6
    },
    {
        "college_code": "NIT_WARANGAL",
        "college_name": "National Institute of Technology Warangal",
    ...
    # ── NIT Jaipur (MNIT) ───────────────────────────────────────────────────
    {
        "college_code": "MNIT_JAIPUR",
        "college_name": "Malaviya National Institute of Technology Jaipur",
        "branch_code": "2580",
        "branch_name": "Computer Science and Engineering",
        "category": "OPEN",
        "sub_category": "NONE",
    ...
    # ── MNNIT Allahabad ─────────────────────────────────────────────────────
    {
        "college_code": "MNNIT_ALLAHABAD",
        "college_name": "Motilal Nehru National Institute of Technology Allahabad",
        "branch_code": "2481",
        "branch_name": "Computer Science and Engineering",
        "category": "OPEN",
        "sub_category": "NONE",
    ...
    # ── NIT Kurukshetra ─────────────────────────────────────────────────────
    {
        "college_code": "NIT_KURUKSHETRA",
        "college_name": "National Institute of Technology Kurukshetra",
        "branch_code": "3009",
        "branch_name": "Computer Science and Engineering",
        "category": "OPEN",
        "sub_category": "NONE",
    ...
    # ── SVNIT Surat ─────────────────────────────────────────────────────────
    {
        "college_code": "SVNIT_SURAT",
        "college_name": "Sardar Vallabhbhai National Institute of Technology Surat",
        "branch_code": "3409",
        "branch_name": "Computer Science and Engineering",
        "category": "OPEN",
        "sub_category": "NONE",
    ...
    {
        "college_code": "IIITM_GWALIOR",
        "college_name": "ABV-Indian Institute of Information Technology and Management Gwalior",
        "branch_code": "E301",
        "branch_name": "Computer Science and Engineering",
        "category": "OPEN",
        "sub_category": "NONE",
    ...
    # ── PEC Chandigarh — GFTI ────────────────────────────────────────────────
    {
        "college_code": "PEC_CHANDIGARH",
        "college_name": "Punjab Engineering College (Deemed to be University) Chandigarh",
        "branch_code": "6001",
        "branch_name": "Computer Science and Engineering",
        "category": "OPEN",
        "sub_category": "NONE",
    ...
    # ── NIT Hamirpur ────────────────────────────────────────────────────────
    {
        "college_code": "NIT_HAMIRPUR",
        "college_name": "National Institute of Technology Hamirpur",
        "branch_code": "4409",
        "branch_name": "Computer Science and Engineering",
        "category": "OPEN",
        "sub_category": "NONE",
...
def _generate_synthetic_extensions(
...
def validate_row_count(min_rows: int = 50_000) -> bool:
    ...
    try:
        with conn.cursor() as cur:
            cur.execute(
                "SELECT COUNT(*) FROM exam_cutoffs WHERE exam_type = 'JEE_MAIN'"
            )
...
if __name__ == "__main__":
    ...
    if not dry:
        ...
        if not ok:
            logger.warning(
                "Row count below 50,000 threshold. Consider adding more base colleges."
            )

...
def test_validate_schema_success(agent: ContentValidationAgent, valid_record: dict) -> None:
...
def test_validate_schema_invalid_types(agent: ContentValidationAgent, valid_record: dict) -> None:
...
def test_validate_range_success(agent: ContentValidationAgent, valid_record: dict) -> None:
    errors = agent.validate_range(valid_record)
    assert len(errors) == 0

def test_validate_range_failure(agent: ContentValidationAgent, valid_record: dict) -> None:
    record = valid_record.copy()
...
def test_validate_historical_sparse_data(agent: ContentValidationAgent, valid_record: dict) -> None:
...
def test_validate_historical_3_sigma_anomaly(agent: ContentValidationAgent, valid_record: dict) -> None:

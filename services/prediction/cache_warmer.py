...
def warm_cache() -> None:
    ...
    from services.prediction.main import (
    ...
    try:
        ...
        logger.info(
            f"Cache warmer retrieved {len(results)} popular queries from prediction_logs."
        )
        ...
        logger.info(
            f"Cache warmer finished. Pre-warmed {warmed_count} prediction queries."
        )

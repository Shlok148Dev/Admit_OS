...
from services.user.schemas import (
    UserProfileResponse, UserProfileUpdate, ExamDetailsRegister,
    StudentProfileResponse, MessageResponse, PredictionHistoryResponse
)
from services.user.profiles import update_or_create_exam_details, get_predictions_history
...
@app.get("/v1/profile/me/predictions-history", response_model=list[PredictionHistoryResponse])

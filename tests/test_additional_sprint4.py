...
from services.counseling.rag.retriever import _keyword_boost, RECENCY_WEIGHTS, DEFAULT_RECENCY_WEIGHT
...
def test_counseling_keyword_boost_exact():
    ...
    boost = _keyword_boost("counseling rules for JoSAA", "This chunk contains JoSAA rules.")
    assert boost > 0.0
...
def test_cache_warmer_success_flow(mock_make_resp, mock_run_pipeline, mock_set_cache, mock_session_local):
